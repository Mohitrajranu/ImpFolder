...
echo Process CallBack Provision Retry Started at $df_date
#LOG=/home/mbas/BackEndProcess/lib/log4j-1.2.6.jar
#export $LOG

java  com/btsl/platformRetry/PlatformProvisionRetryTask 1>>$LOG_BASE/backEndProcessLogs/PlatformProvisionRetryTask_out.log.$today 2>>$LOG_BASE/backEndProcessLogs/PlatformProvisionRetryTask_err.log.$today
